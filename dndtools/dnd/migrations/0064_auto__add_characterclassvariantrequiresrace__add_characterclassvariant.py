...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_characterclassvariantrequiresrace', (
        ...
        db.send_create_signal('dnd', ['CharacterClassVariantRequiresRace'])

        # Adding model 'CharacterClassVariantRequiresSkill'
        db.create_table('dnd_characterclassvariantrequiresskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dnd', ['CharacterClassVariantRequiresSkill'])

        # Adding model 'CharacterClassVariantRequiresFeat'
        db.create_table('dnd_characterclassvariantrequiresfeat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dnd', ['CharacterClassVariantRequiresFeat'])


    def backwards(self, orm):
        
        # Deleting model 'CharacterClassVariantRequiresRace'
        db.delete_table('dnd_characterclassvariantrequiresrace')

        # Deleting model 'CharacterClassVariantRequiresSkill'
        db.delete_table('dnd_characterclassvariantrequiresskill')

        # Deleting model 'CharacterClassVariantRequiresFeat'
        db.delete_table('dnd_characterclassvariantrequiresfeat')
