...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.variant'
        db.add_column('dnd_skill', 'variant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.Skill'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.variant'
        db.delete_column('dnd_skill', 'variant_id')
