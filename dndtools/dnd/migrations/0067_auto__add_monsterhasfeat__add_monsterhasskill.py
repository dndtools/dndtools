...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_monsterhasfeat', (
        ...
        db.send_create_signal('dnd', ['MonsterHasFeat'])

        # Adding model 'MonsterHasSkill'
        db.create_table('dnd_monsterhasskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dnd', ['MonsterHasSkill'])


    def backwards(self, orm):
        
        # Deleting model 'MonsterHasFeat'
        db.delete_table('dnd_monsterhasfeat')

        # Deleting model 'MonsterHasSkill'
        db.delete_table('dnd_monsterhasskill')
