...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterClassVariant.description'
        db.delete_column('dnd_characterclassvariant', 'description')

        # Adding field 'CharacterClassVariant.class_features'
        db.add_column('dnd_characterclassvariant', 'class_features', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CharacterClassVariant.description'
        db.add_column('dnd_characterclassvariant', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'CharacterClassVariant.class_features'
        db.delete_column('dnd_characterclassvariant', 'class_features')
