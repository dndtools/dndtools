...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rulebook.image'
        db.add_column('dnd_rulebook', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rulebook.image'
        db.delete_column('dnd_rulebook', 'image')
