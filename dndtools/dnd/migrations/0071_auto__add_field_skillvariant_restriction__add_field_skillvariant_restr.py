...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SkillVariant.restriction'
        db.add_column('dnd_skillvariant', 'restriction', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.restriction_html'
        db.add_column('dnd_skillvariant', 'restriction_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SkillVariant.restriction'
        db.delete_column('dnd_skillvariant', 'restriction')

        # Deleting field 'SkillVariant.restriction_html'
        db.delete_column('dnd_skillvariant', 'restriction_html')
