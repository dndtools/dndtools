...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FeatCategory', fields ['slug']
        db.create_unique('dnd_featcategory', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FeatCategory', fields ['slug']
        db.delete_unique('dnd_featcategory', ['slug'])
