...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spell.description_html'
        db.add_column('dnd_spell', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spell.description_html'
        db.delete_column('dnd_spell', 'description_html')
