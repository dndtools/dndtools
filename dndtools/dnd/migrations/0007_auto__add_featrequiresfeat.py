...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_featrequiresfeat', (
            ...
            ('additional_text', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('dnd', ['FeatRequiresFeat'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('dnd_featrequiresfeat')
