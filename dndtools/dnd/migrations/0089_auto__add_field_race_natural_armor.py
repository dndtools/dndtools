...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Race.natural_armor'
        db.add_column('dnd_race', 'natural_armor', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Race.natural_armor'
        db.delete_column('dnd_race', 'natural_armor')
