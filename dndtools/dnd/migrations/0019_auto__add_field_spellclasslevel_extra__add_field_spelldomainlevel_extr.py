...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpellClassLevel.extra'
        db.add_column('dnd_spellclasslevel', 'extra', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'SpellDomainLevel.extra'
        db.add_column('dnd_spelldomainlevel', 'extra', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SpellClassLevel.extra'
        db.delete_column('dnd_spellclasslevel', 'extra')

        # Deleting field 'SpellDomainLevel.extra'
        db.delete_column('dnd_spelldomainlevel', 'extra')
