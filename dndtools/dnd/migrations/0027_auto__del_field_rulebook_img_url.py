...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rulebook.img_url'
        db.delete_column('dnd_rulebook', 'img_url')


    def backwards(self, orm):
        
        # Adding field 'Rulebook.img_url'
        db.add_column('dnd_rulebook', 'img_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
