...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dnd_skill', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64))

        # Changing field 'Skill.slug'
        db.alter_column('dnd_skill', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64))


    def backwards(self, orm):
        
        # Changing field 'Skill.name'
        db.alter_column('dnd_skill', 'name', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))

        # Changing field 'Skill.slug'
        db.alter_column('dnd_skill', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True))
