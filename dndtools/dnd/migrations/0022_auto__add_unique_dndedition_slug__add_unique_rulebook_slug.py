...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DndEdition', fields ['slug']
        db.create_unique('dnd_dndedition', ['slug'])

        # Adding unique constraint on 'Rulebook', fields ['slug']
        db.create_unique('dnd_rulebook', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Rulebook', fields ['slug']
        db.delete_unique('dnd_rulebook', ['slug'])

        # Removing unique constraint on 'DndEdition', fields ['slug']
        db.delete_unique('dnd_dndedition', ['slug'])
