...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Race.description_html'
        db.add_column('dnd_race', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Race.combat_html'
        db.add_column('dnd_race', 'combat_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Race.racial_traits_html'
        db.add_column('dnd_race', 'racial_traits_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Race.description_html'
        db.delete_column('dnd_race', 'description_html')

        # Deleting field 'Race.combat_html'
        db.delete_column('dnd_race', 'combat_html')

        # Deleting field 'Race.racial_traits_html'
        db.delete_column('dnd_race', 'racial_traits_html')
