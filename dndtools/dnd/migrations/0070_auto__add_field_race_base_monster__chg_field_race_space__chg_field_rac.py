...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Race.space'
        db.alter_column('dnd_race', 'space', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Race.reach'
        db.alter_column('dnd_race', 'reach', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
