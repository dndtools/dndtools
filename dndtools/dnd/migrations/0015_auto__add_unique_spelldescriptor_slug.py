...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SpellDescriptor', fields ['slug']
        db.create_unique('dnd_spelldescriptor', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SpellDescriptor', fields ['slug']
        db.delete_unique('dnd_spelldescriptor', ['slug'])
