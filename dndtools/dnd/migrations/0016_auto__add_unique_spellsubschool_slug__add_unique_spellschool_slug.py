...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SpellSubSchool', fields ['slug']
        db.create_unique('dnd_spellsubschool', ['slug'])

        # Adding unique constraint on 'SpellSchool', fields ['slug']
        db.create_unique('dnd_spellschool', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SpellSchool', fields ['slug']
        db.delete_unique('dnd_spellschool', ['slug'])

        # Removing unique constraint on 'SpellSubSchool', fields ['slug']
        db.delete_unique('dnd_spellsubschool', ['slug'])
