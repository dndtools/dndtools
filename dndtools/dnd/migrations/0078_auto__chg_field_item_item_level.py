...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.item_level'
        db.alter_column('dnd_item', 'item_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Item.item_level'
        db.alter_column('dnd_item', 'item_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))
