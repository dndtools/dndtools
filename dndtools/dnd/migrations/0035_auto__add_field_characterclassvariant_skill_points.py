...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterClassVariant.skill_points'
        db.add_column('dnd_characterclassvariant', 'skill_points', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field class_skills on 'CharacterClassVariant'
        db.create_table('dnd_characterclassvariant_class_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('characterclassvariant', models.ForeignKey(orm['dnd.characterclassvariant'], null=False)),
            ('skill', models.ForeignKey(orm['dnd.skill'], null=False))
        ))
        db.create_unique('dnd_characterclassvariant_class_skills', ['characterclassvariant_id', 'skill_id'])


    def backwards(self, orm):
        
        # Deleting field 'CharacterClassVariant.skill_points'
        db.delete_column('dnd_characterclassvariant', 'skill_points')

        # Removing M2M table for field class_skills on 'CharacterClassVariant'
        db.delete_table('dnd_characterclassvariant_class_skills')
