...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterClassVariant.class_features_html'
        db.add_column('dnd_characterclassvariant', 'class_features_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.description_html'
        db.add_column('dnd_skillvariant', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.check_html'
        db.add_column('dnd_skillvariant', 'check_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.action_html'
        db.add_column('dnd_skillvariant', 'action_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.try_again_html'
        db.add_column('dnd_skillvariant', 'try_again_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.special_html'
        db.add_column('dnd_skillvariant', 'special_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.synergy_html'
        db.add_column('dnd_skillvariant', 'synergy_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SkillVariant.untrained_html'
        db.add_column('dnd_skillvariant', 'untrained_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CharacterClassVariant.class_features_html'
        db.delete_column('dnd_characterclassvariant', 'class_features_html')

        # Deleting field 'SkillVariant.description_html'
        db.delete_column('dnd_skillvariant', 'description_html')

        # Deleting field 'SkillVariant.check_html'
        db.delete_column('dnd_skillvariant', 'check_html')

        # Deleting field 'SkillVariant.action_html'
        db.delete_column('dnd_skillvariant', 'action_html')

        # Deleting field 'SkillVariant.try_again_html'
        db.delete_column('dnd_skillvariant', 'try_again_html')

        # Deleting field 'SkillVariant.special_html'
        db.delete_column('dnd_skillvariant', 'special_html')

        # Deleting field 'SkillVariant.synergy_html'
        db.delete_column('dnd_skillvariant', 'synergy_html')

        # Deleting field 'SkillVariant.untrained_html'
        db.delete_column('dnd_skillvariant', 'untrained_html')
