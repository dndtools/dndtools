...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spell.corrupt_level'
        db.add_column('dnd_spell', 'corrupt_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spell.corrupt_level'
        db.delete_column('dnd_spell', 'corrupt_level')
