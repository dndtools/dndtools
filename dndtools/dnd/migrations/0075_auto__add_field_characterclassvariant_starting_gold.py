...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterClassVariant.starting_gold'
        db.add_column('dnd_characterclassvariant', 'starting_gold', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CharacterClassVariant.starting_gold'
        db.delete_column('dnd_characterclassvariant', 'starting_gold')
