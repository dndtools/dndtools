...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_item', (
            ...
            ('item_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('body_slot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemSlot'])),
            ('caster_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('aura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemAuraType'])),
            ('aura_dc', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('activation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemActivationType'], blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('visual_description', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('description_html', self.gf('django.db.models.fields.TextField')()),
            ('brew_potion', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('craft_magical_arms_and_armor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('craft_rod', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('craft_staff', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('craft_wand', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('craft_wondrous_item', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('forge_ring', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('scribe_scroll', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('dnd', ['Item'])

        # Adding M2M table for field aura_school on 'Item'
        db.create_table('dnd_item_aura_school', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm['dnd.item'], null=False)),
            ('spellschool', models.ForeignKey(orm['dnd.spellschool'], null=False))
        ))
        db.create_unique('dnd_item_aura_school', ['item_id', 'spellschool_id'])
        ...
        db.create_table('dnd_itemslot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64, db_index=True)),
        ))
        db.send_create_signal('dnd', ['ItemSlot'])

        # Adding model 'ItemActivationType'
        db.create_table('dnd_itemactivationtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64, db_index=True)),
        ))
        db.send_create_signal('dnd', ['ItemActivationType'])

        # Adding model 'ItemAuraType'
        db.create_table('dnd_itemauratype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=64, db_index=True)),
        ))
        db.send_create_signal('dnd', ['ItemAuraType'])


    def backwards(self, orm):
        
        # Deleting model 'Item'
        db.delete_table('dnd_item')

        # Removing M2M table for field aura_school on 'Item'
        db.delete_table('dnd_item_aura_school')

        # Removing M2M table for field required_spells on 'Item'
        db.delete_table('dnd_item_required_spells')

        # Deleting model 'ItemSlot'
        db.delete_table('dnd_itemslot')

        # Deleting model 'ItemActivationType'
        db.delete_table('dnd_itemactivationtype')

        # Deleting model 'ItemAuraType'
        db.delete_table('dnd_itemauratype')
    ...
    models = {
        ...
        'dnd.item': {
            ...
            'activation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.ItemActivationType']", 'blank': 'True'}),
            'aura': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.ItemAuraType']"}),
            'aura_dc': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'aura_school': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['dnd.SpellSchool']", 'symmetrical': 'False', 'blank': 'True'}),
            'body_slot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.ItemSlot']"}),
            'brew_potion': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'caster_level': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'craft_magical_arms_and_armor': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'craft_rod': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'craft_staff': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'craft_wand': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'craft_wondrous_item': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'description_html': ('django.db.models.fields.TextField', [], {}),
            'forge_ring': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_level': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'db_index': 'True'}),
            'page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'rulebook': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.Rulebook']"}),
            'scribe_scroll': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '64', 'db_index': 'True'}),
            'visual_description': ('django.db.models.fields.TextField', [], {}),
            'weight': ('django.db.models.fields.FloatField', [], {'blank': 'True'})
        },
        'dnd.itemactivationtype': {
            'Meta': {'object_name': 'ItemActivationType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '64', 'db_index': 'True'})
        },
        'dnd.itemauratype': {
            'Meta': {'object_name': 'ItemAuraType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '64', 'db_index': 'True'})
        },
        'dnd.itemslot': {
            'Meta': {'object_name': 'ItemSlot'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '64', 'db_index': 'True'})
        },
