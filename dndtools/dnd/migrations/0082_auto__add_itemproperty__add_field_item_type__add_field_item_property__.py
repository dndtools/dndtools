...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_itemproperty', (
        ...
        db.send_create_signal('dnd', ['ItemProperty'])

        # Adding field 'Item.type'
        db.add_column('dnd_item', 'type', self.gf('django.db.models.fields.CharField')(default='MAG', max_length=3), keep_default=False)

        # Adding field 'Item.property'
        db.add_column('dnd_item', 'property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemProperty'], null=True, blank=True), keep_default=False)

        # Adding field 'Item.cost_to_create'
        db.add_column('dnd_item', 'cost_to_create', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'Item.synergy_prerequisite'
        db.add_column('dnd_item', 'synergy_prerequisite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.Item'], null=True, blank=True), keep_default=False)

        # Changing field 'Item.aura'
        db.alter_column('dnd_item', 'aura_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemAuraType'], null=True))

        # Changing field 'Item.body_slot'
        db.alter_column('dnd_item', 'body_slot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemSlot'], null=True))

        # Changing field 'Item.caster_level'
        db.alter_column('dnd_item', 'caster_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Deleting model 'ItemProperty'
        db.delete_table('dnd_itemproperty')

        # Deleting field 'Item.type'
        db.delete_column('dnd_item', 'type')

        # Deleting field 'Item.property'
        db.delete_column('dnd_item', 'property_id')

        # Deleting field 'Item.cost_to_create'
        db.delete_column('dnd_item', 'cost_to_create')

        # Deleting field 'Item.synergy_prerequisite'
        db.delete_column('dnd_item', 'synergy_prerequisite_id')

        # User chose to not deal with backwards NULL issues for 'Item.aura'
        raise RuntimeError("Cannot reverse this migration. 'Item.aura' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Item.body_slot'
        raise RuntimeError("Cannot reverse this migration. 'Item.body_slot' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Item.caster_level'
        raise RuntimeError("Cannot reverse this migration. 'Item.caster_level' and its values cannot be restored.")
