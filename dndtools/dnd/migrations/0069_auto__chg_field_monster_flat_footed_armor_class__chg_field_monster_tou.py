...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Monster.flat_footed_armor_class'
        db.alter_column('dnd_monster', 'flat_footed_armor_class', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Monster.touch_armor_class'
        db.alter_column('dnd_monster', 'touch_armor_class', self.gf('django.db.models.fields.SmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Monster.flat_footed_armor_class'
        db.alter_column('dnd_monster', 'flat_footed_armor_class', self.gf('django.db.models.fields.SmallIntegerField')(default=0))

        # Changing field 'Monster.touch_armor_class'
        db.alter_column('dnd_monster', 'touch_armor_class', self.gf('django.db.models.fields.SmallIntegerField')(default=0))
