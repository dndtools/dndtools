...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MonsterType', fields ['slug']
        db.create_unique('dnd_monstertype', ['slug'])

        # Adding unique constraint on 'MonsterSubtype', fields ['slug']
        db.create_unique('dnd_monstersubtype', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MonsterSubtype', fields ['slug']
        db.delete_unique('dnd_monstersubtype', ['slug'])

        # Removing unique constraint on 'MonsterType', fields ['slug']
        db.delete_unique('dnd_monstertype', ['slug'])
