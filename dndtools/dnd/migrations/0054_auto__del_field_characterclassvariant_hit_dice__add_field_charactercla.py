...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterClassVariant.hit_dice'
        db.delete_column('dnd_characterclassvariant', 'hit_dice')

        # Adding field 'CharacterClassVariant.hit_die'
        db.add_column('dnd_characterclassvariant', 'hit_die', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'CharacterClassVariant.alignment'
        db.add_column('dnd_characterclassvariant', 'alignment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CharacterClassVariant.hit_dice'
        db.add_column('dnd_characterclassvariant', 'hit_dice', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'CharacterClassVariant.hit_die'
        db.delete_column('dnd_characterclassvariant', 'hit_die')

        # Deleting field 'CharacterClassVariant.alignment'
        db.delete_column('dnd_characterclassvariant', 'alignment')
    ...
    models = {
        ...
        'dnd.characterclassvariant': {
            ...
            'alignment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
