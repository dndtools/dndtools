...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CharacterClassVariant.hit_die'
        db.alter_column('dnd_characterclassvariant', 'hit_die', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CharacterClassVariant.hit_die'
        raise RuntimeError("Cannot reverse this migration. 'CharacterClassVariant.hit_die' and its values cannot be restored.")
