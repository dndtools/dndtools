...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('dnd', ['RaceSize'])

        # Adding field 'Race.size'
        db.add_column('dnd_race', 'size', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.RaceSize'], null=True), keep_default=False)

        # Changing field 'Race.base_land_speed'
        db.alter_column('dnd_race', 'base_land_speed', self.gf('django.db.models.fields.PositiveSmallIntegerField')())


    def backwards(self, orm):
        
        # Deleting model 'RaceSize'
        db.delete_table('dnd_racesize')

        # Deleting field 'Race.size'
        db.delete_column('dnd_race', 'size_id')

        # Changing field 'Race.base_land_speed'
        db.alter_column('dnd_race', 'base_land_speed', self.gf('django.db.models.fields.SmallIntegerField')())
