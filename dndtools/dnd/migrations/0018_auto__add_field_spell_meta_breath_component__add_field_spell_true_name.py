...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spell.meta_breath_component'
        db.add_column('dnd_spell', 'meta_breath_component', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Spell.true_name_component'
        db.add_column('dnd_spell', 'true_name_component', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Spell.extra_components'
        db.add_column('dnd_spell', 'extra_components', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spell.meta_breath_component'
        db.delete_column('dnd_spell', 'meta_breath_component')

        # Deleting field 'Spell.true_name_component'
        db.delete_column('dnd_spell', 'true_name_component')

        # Deleting field 'Spell.extra_components'
        db.delete_column('dnd_spell', 'extra_components')
