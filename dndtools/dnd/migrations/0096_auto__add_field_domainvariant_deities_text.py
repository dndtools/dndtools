...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DomainVariant.deities_text'
        db.add_column('dnd_domainvariant', 'deities_text', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DomainVariant.deities_text'
        db.delete_column('dnd_domainvariant', 'deities_text')
