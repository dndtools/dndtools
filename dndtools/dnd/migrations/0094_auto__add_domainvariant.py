...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_domainvariant', (
            ...
            ('deities', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('other_deities', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
        ...
        db.send_create_signal('dnd', ['DomainVariant'])


    def backwards(self, orm):
        
        # Deleting model 'DomainVariant'
        db.delete_table('dnd_domainvariant')
    ...
    models = {
        ...
        'dnd.domainvariant': {
            ...
            'deities': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_deities': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
