...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spell.verified'
        db.add_column('dnd_spell', 'verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Spell.verified_author'
        db.add_column('dnd_spell', 'verified_author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Spell.verified_time'
        db.add_column('dnd_spell', 'verified_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spell.verified'
        db.delete_column('dnd_spell', 'verified')

        # Deleting field 'Spell.verified_author'
        db.delete_column('dnd_spell', 'verified_author_id')

        # Deleting field 'Spell.verified_time'
        db.delete_column('dnd_spell', 'verified_time')
    ...
    models = {
        ...
        'dnd.spell': {
            ...
            'verified_author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
