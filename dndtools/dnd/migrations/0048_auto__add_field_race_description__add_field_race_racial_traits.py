...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dnd_race', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Race.racial_traits'
        db.add_column('dnd_race', 'racial_traits', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Race.description'
        db.delete_column('dnd_race', 'description')

        # Deleting field 'Race.racial_traits'
        db.delete_column('dnd_race', 'racial_traits')
