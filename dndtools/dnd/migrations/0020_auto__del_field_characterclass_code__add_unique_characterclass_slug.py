...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CharacterClass.code'
        db.delete_column('dnd_characterclass', 'code')

        # Adding unique constraint on 'CharacterClass', fields ['slug']
        db.create_unique('dnd_characterclass', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CharacterClass', fields ['slug']
        db.delete_unique('dnd_characterclass', ['slug'])

        # Adding field 'CharacterClass.code'
        db.add_column('dnd_characterclass', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)
