...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dnd_item', 'weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Item.activation'
        db.alter_column('dnd_item', 'activation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.ItemActivationType'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Item.activation'
        raise RuntimeError("Cannot reverse this migration. 'Item.activation' and its values cannot be restored.")
