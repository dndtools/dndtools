...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterClassVariantRequiresRace.text_before'
        db.add_column('dnd_characterclassvariantrequiresrace', 'text_before', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresRace.text_after'
        db.add_column('dnd_characterclassvariantrequiresrace', 'text_after', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresRace.remove_comma'
        db.add_column('dnd_characterclassvariantrequiresrace', 'remove_comma', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresSkill.text_before'
        db.add_column('dnd_characterclassvariantrequiresskill', 'text_before', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresSkill.text_after'
        db.add_column('dnd_characterclassvariantrequiresskill', 'text_after', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresSkill.remove_comma'
        db.add_column('dnd_characterclassvariantrequiresskill', 'remove_comma', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresFeat.text_before'
        db.add_column('dnd_characterclassvariantrequiresfeat', 'text_before', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresFeat.text_after'
        db.add_column('dnd_characterclassvariantrequiresfeat', 'text_after', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'CharacterClassVariantRequiresFeat.remove_comma'
        db.add_column('dnd_characterclassvariantrequiresfeat', 'remove_comma', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CharacterClassVariantRequiresRace.text_before'
        db.delete_column('dnd_characterclassvariantrequiresrace', 'text_before')

        # Deleting field 'CharacterClassVariantRequiresRace.text_after'
        db.delete_column('dnd_characterclassvariantrequiresrace', 'text_after')

        # Deleting field 'CharacterClassVariantRequiresRace.remove_comma'
        db.delete_column('dnd_characterclassvariantrequiresrace', 'remove_comma')

        # Deleting field 'CharacterClassVariantRequiresSkill.text_before'
        db.delete_column('dnd_characterclassvariantrequiresskill', 'text_before')

        # Deleting field 'CharacterClassVariantRequiresSkill.text_after'
        db.delete_column('dnd_characterclassvariantrequiresskill', 'text_after')

        # Deleting field 'CharacterClassVariantRequiresSkill.remove_comma'
        db.delete_column('dnd_characterclassvariantrequiresskill', 'remove_comma')

        # Deleting field 'CharacterClassVariantRequiresFeat.text_before'
        db.delete_column('dnd_characterclassvariantrequiresfeat', 'text_before')

        # Deleting field 'CharacterClassVariantRequiresFeat.text_after'
        db.delete_column('dnd_characterclassvariantrequiresfeat', 'text_after')

        # Deleting field 'CharacterClassVariantRequiresFeat.remove_comma'
        db.delete_column('dnd_characterclassvariantrequiresfeat', 'remove_comma')
