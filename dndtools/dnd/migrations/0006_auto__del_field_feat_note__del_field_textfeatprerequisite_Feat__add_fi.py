...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Feat.note'
        db.delete_column('dnd_feat', 'note')

        # Deleting field 'TextFeatPrerequisite.Feat'
        db.delete_column('dnd_textfeatprerequisite', 'Feat_id')

        # Adding field 'TextFeatPrerequisite.feat'
        db.add_column('dnd_textfeatprerequisite', 'feat', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dnd.Feat']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Feat.note'
        raise RuntimeError("Cannot reverse this migration. 'Feat.note' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TextFeatPrerequisite.Feat'
        raise RuntimeError("Cannot reverse this migration. 'TextFeatPrerequisite.Feat' and its values cannot be restored.")
