...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Domain.code'
        db.delete_column('dnd_domain', 'code')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Domain.code'
        raise RuntimeError("Cannot reverse this migration. 'Domain.code' and its values cannot be restored.")
