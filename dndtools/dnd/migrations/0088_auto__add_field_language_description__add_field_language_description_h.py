...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Language.description'
        db.add_column('dnd_language', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Language.description_html'
        db.add_column('dnd_language', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Language.description'
        db.delete_column('dnd_language', 'description')

        # Deleting field 'Language.description_html'
        db.delete_column('dnd_language', 'description_html')
