...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CharacterClassVariant', fields ['rulebook', 'character_class']
        db.create_unique('dnd_characterclassvariant', ['rulebook_id', 'character_class_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CharacterClassVariant', fields ['rulebook', 'character_class']
        db.delete_unique('dnd_characterclassvariant', ['rulebook_id', 'character_class_id'])
