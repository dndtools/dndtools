...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CharacterClassVariant.alignment'
        db.alter_column('dnd_characterclassvariant', 'alignment', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'CharacterClassVariant.alignment'
        db.alter_column('dnd_characterclassvariant', 'alignment', self.gf('django.db.models.fields.TextField')())
