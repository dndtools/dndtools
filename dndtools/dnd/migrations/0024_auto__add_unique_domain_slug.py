...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Domain', fields ['slug']
        db.create_unique('dnd_domain', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Domain', fields ['slug']
        db.delete_unique('dnd_domain', ['slug'])
