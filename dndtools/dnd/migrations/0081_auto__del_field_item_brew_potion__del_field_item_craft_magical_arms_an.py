...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.brew_potion'
        db.delete_column('dnd_item', 'brew_potion')

        # Deleting field 'Item.craft_magical_arms_and_armor'
        db.delete_column('dnd_item', 'craft_magical_arms_and_armor')

        # Deleting field 'Item.scribe_scroll'
        db.delete_column('dnd_item', 'scribe_scroll')

        # Deleting field 'Item.craft_wand'
        db.delete_column('dnd_item', 'craft_wand')

        # Deleting field 'Item.craft_rod'
        db.delete_column('dnd_item', 'craft_rod')

        # Deleting field 'Item.craft_staff'
        db.delete_column('dnd_item', 'craft_staff')

        # Deleting field 'Item.forge_ring'
        db.delete_column('dnd_item', 'forge_ring')

        # Deleting field 'Item.craft_wondrous_item'
        db.delete_column('dnd_item', 'craft_wondrous_item')

        # Adding M2M table for field required_feats on 'Item'
        db.create_table('dnd_item_required_feats', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm['dnd.item'], null=False)),
            ('feat', models.ForeignKey(orm['dnd.feat'], null=False))
        ))
        db.create_unique('dnd_item_required_feats', ['item_id', 'feat_id'])


    def backwards(self, orm):
        
        # Adding field 'Item.brew_potion'
        db.add_column('dnd_item', 'brew_potion', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.craft_magical_arms_and_armor'
        db.add_column('dnd_item', 'craft_magical_arms_and_armor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.scribe_scroll'
        db.add_column('dnd_item', 'scribe_scroll', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.craft_wand'
        db.add_column('dnd_item', 'craft_wand', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.craft_rod'
        db.add_column('dnd_item', 'craft_rod', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.craft_staff'
        db.add_column('dnd_item', 'craft_staff', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.forge_ring'
        db.add_column('dnd_item', 'forge_ring', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Item.craft_wondrous_item'
        db.add_column('dnd_item', 'craft_wondrous_item', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Removing M2M table for field required_feats on 'Item'
        db.delete_table('dnd_item_required_feats')
