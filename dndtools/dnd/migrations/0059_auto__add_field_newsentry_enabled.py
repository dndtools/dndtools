...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsEntry.enabled'
        db.add_column('dnd_newsentry', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsEntry.enabled'
        db.delete_column('dnd_newsentry', 'enabled')
