...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spell.corrupt_component'
        db.add_column('dnd_spell', 'corrupt_component', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spell.corrupt_component'
        db.delete_column('dnd_spell', 'corrupt_component')
