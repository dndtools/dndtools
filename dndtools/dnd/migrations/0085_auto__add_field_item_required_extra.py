...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.required_extra'
        db.add_column('dnd_item', 'required_extra', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.required_extra'
        db.delete_column('dnd_item', 'required_extra')
