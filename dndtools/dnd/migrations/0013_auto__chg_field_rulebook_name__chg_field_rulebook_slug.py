...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rulebook.name'
        db.alter_column('dnd_rulebook', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Rulebook.slug'
        db.alter_column('dnd_rulebook', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=128))


    def backwards(self, orm):
        
        # Changing field 'Rulebook.name'
        db.alter_column('dnd_rulebook', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        'dnd.skill': {
            ...
            'variant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.Skill']", 'null': 'True', 'blank': 'True'})
        },
