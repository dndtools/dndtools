...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeatRequiresSkill.extra'
        db.add_column('dnd_featrequiresskill', 'extra', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeatRequiresSkill.extra'
        db.delete_column('dnd_featrequiresskill', 'extra')
