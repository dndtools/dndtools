...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('dnd', ['Deity'])

        # Deleting field 'DomainVariant.deities'
        db.delete_column('dnd_domainvariant', 'deities')

        # Deleting field 'DomainVariant.other_deities'
        db.delete_column('dnd_domainvariant', 'other_deities')

        # Adding M2M table for field deities on 'DomainVariant'
        db.create_table('dnd_domainvariant_deities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('domainvariant', models.ForeignKey(orm['dnd.domainvariant'], null=False)),
            ('deity', models.ForeignKey(orm['dnd.deity'], null=False))
        ))
        db.create_unique('dnd_domainvariant_deities', ['domainvariant_id', 'deity_id'])

        # Adding M2M table for field other_deities on 'DomainVariant'
        db.create_table('dnd_domainvariant_other_deities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('domainvariant', models.ForeignKey(orm['dnd.domainvariant'], null=False)),
            ('deity', models.ForeignKey(orm['dnd.deity'], null=False))
        ))
        db.create_unique('dnd_domainvariant_other_deities', ['domainvariant_id', 'deity_id'])


    def backwards(self, orm):
        
        # Deleting model 'Deity'
        db.delete_table('dnd_deity')

        # Adding field 'DomainVariant.deities'
        db.add_column('dnd_domainvariant', 'deities', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'DomainVariant.other_deities'
        db.add_column('dnd_domainvariant', 'other_deities', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Removing M2M table for field deities on 'DomainVariant'
        db.delete_table('dnd_domainvariant_deities')

        # Removing M2M table for field other_deities on 'DomainVariant'
        db.delete_table('dnd_domainvariant_other_deities')
    ...
    models = {
        ...
        'dnd.deity': {
            ...
            'favored_weapon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.Item']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dnd.domainvariant': {
            ...
            'deities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'primary_domains'", 'blank': 'True', 'to': "orm['dnd.Deity']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_deities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'other_domains'", 'blank': 'True', 'to': "orm['dnd.Deity']"}),
            'page': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
