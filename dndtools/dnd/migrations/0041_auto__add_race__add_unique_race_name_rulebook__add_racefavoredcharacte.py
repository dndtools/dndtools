...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_race', (
            ...
            ('str', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('dex', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('con', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('int', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('wis', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('cha', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('base_land_speed', self.gf('django.db.models.fields.SmallIntegerField')(default=30)),
            ('level_adjustment', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal('dnd', ['Race'])

        # Adding unique constraint on 'Race', fields ['name', 'rulebook']
        db.create_unique('dnd_race', ['name', 'rulebook_id'])

        # Adding model 'RaceFavoredCharacterClass'
        db.create_table('dnd_racefavoredcharacterclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dnd', ['RaceFavoredCharacterClass'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Race', fields ['name', 'rulebook']
        db.delete_unique('dnd_race', ['name', 'rulebook_id'])

        # Deleting model 'Race'
        db.delete_table('dnd_race')

        # Deleting model 'RaceFavoredCharacterClass'
        db.delete_table('dnd_racefavoredcharacterclass')
    ...
    models = {
        ...
        'dnd.race': {
            ...
            'base_land_speed': ('django.db.models.fields.SmallIntegerField', [], {'default': '30'}),
            'cha': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'con': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'dex': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'int': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'str': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'wis': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
