...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('dnd_racespeed')

        # Deleting model 'RaceSpeedType'
        db.delete_table('dnd_racespeedtype')

        # Adding field 'Race.base_land_speed'
        db.add_column('dnd_race', 'base_land_speed', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=30), keep_default=False)

        # Deleting field 'Race.combat'
        db.delete_column('dnd_race', 'combat')

        # Removing M2M table for field speeds on 'Race'
        db.delete_table('dnd_race_speeds')
    ...
    models = {
        ...
        'dnd.race': {
            ...
            'speeds': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['dnd.RaceSpeed']", 'symmetrical': 'False'}),
        ...
        'dnd.racespeed': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dnd.RaceSpeedType']"})
        },
        'dnd.racespeedtype': {
