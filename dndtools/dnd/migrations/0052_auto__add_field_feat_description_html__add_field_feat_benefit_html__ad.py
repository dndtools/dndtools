...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feat.description_html'
        db.add_column('dnd_feat', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Feat.benefit_html'
        db.add_column('dnd_feat', 'benefit_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Feat.special_html'
        db.add_column('dnd_feat', 'special_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Feat.normal_html'
        db.add_column('dnd_feat', 'normal_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feat.description_html'
        db.delete_column('dnd_feat', 'description_html')

        # Deleting field 'Feat.benefit_html'
        db.delete_column('dnd_feat', 'benefit_html')

        # Deleting field 'Feat.special_html'
        db.delete_column('dnd_feat', 'special_html')

        # Deleting field 'Feat.normal_html'
        db.delete_column('dnd_feat', 'normal_html')
