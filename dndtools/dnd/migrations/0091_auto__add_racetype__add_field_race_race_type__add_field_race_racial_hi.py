...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('dnd', ['RaceType'])

        # Adding field 'Race.race_type'
        db.add_column('dnd_race', 'race_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnd.RaceType'], null=True, blank=True), keep_default=False)

        # Adding field 'Race.racial_hit_dice_count'
        db.add_column('dnd_race', 'racial_hit_dice_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RaceType'
        db.delete_table('dnd_racetype')

        # Deleting field 'Race.race_type'
        db.delete_column('dnd_race', 'race_type_id')

        # Deleting field 'Race.racial_hit_dice_count'
        db.delete_column('dnd_race', 'racial_hit_dice_count')
