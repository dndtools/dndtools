...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnd_skillvariant', (
        ...
        db.send_create_signal('dnd', ['SkillVariant'])

        # Adding unique constraint on 'SkillVariant', fields ['skill', 'rulebook']
        db.create_unique('dnd_skillvariant', ['skill_id', 'rulebook_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SkillVariant', fields ['skill', 'rulebook']
        db.delete_unique('dnd_skillvariant', ['skill_id', 'rulebook_id'])

        # Deleting model 'SkillVariant'
        db.delete_table('dnd_skillvariant')
