...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DndEdition.core'
        db.add_column('dnd_dndedition', 'core', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DndEdition.core'
        db.delete_column('dnd_dndedition', 'core')
