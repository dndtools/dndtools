...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Skill.untrained'
        db.delete_column('dnd_skill', 'untrained')

        # Deleting field 'Skill.description'
        db.delete_column('dnd_skill', 'description')

        # Deleting field 'Skill.page'
        db.delete_column('dnd_skill', 'page')

        # Deleting field 'Skill.synergy'
        db.delete_column('dnd_skill', 'synergy')

        # Deleting field 'Skill.action'
        db.delete_column('dnd_skill', 'action')

        # Deleting field 'Skill.rulebook'
        db.delete_column('dnd_skill', 'rulebook_id')

        # Deleting field 'Skill.try_again'
        db.delete_column('dnd_skill', 'try_again')

        # Deleting field 'Skill.check'
        db.delete_column('dnd_skill', 'check')

        # Deleting field 'Skill.special'
        db.delete_column('dnd_skill', 'special')

        # Removing index on 'Skill', fields ['name']
        db.delete_index('dnd_skill', ['name'])

        # Adding unique constraint on 'Skill', fields ['name']
        db.create_unique('dnd_skill', ['name'])

        # Adding unique constraint on 'Skill', fields ['slug']
        db.create_unique('dnd_skill', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Skill', fields ['slug']
        db.delete_unique('dnd_skill', ['slug'])

        # Removing unique constraint on 'Skill', fields ['name']
        db.delete_unique('dnd_skill', ['name'])

        # Adding index on 'Skill', fields ['name']
        db.create_index('dnd_skill', ['name'])

        # Adding field 'Skill.untrained'
        db.add_column('dnd_skill', 'untrained', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Skill.description'
        db.add_column('dnd_skill', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
        ...
        # Adding field 'Skill.synergy'
        db.add_column('dnd_skill', 'synergy', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Skill.action'
        db.add_column('dnd_skill', 'action', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Skill.rulebook'
        raise RuntimeError("Cannot reverse this migration. 'Skill.rulebook' and its values cannot be restored.")

        # Adding field 'Skill.try_again'
        db.add_column('dnd_skill', 'try_again', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Skill.check'
        db.add_column('dnd_skill', 'check', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Skill.special'
        db.add_column('dnd_skill', 'special', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
