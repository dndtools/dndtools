...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharacterClass.short_description_html'
        db.add_column('dnd_characterclass', 'short_description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CharacterClass.short_description_html'
        db.delete_column('dnd_characterclass', 'short_description_html')
