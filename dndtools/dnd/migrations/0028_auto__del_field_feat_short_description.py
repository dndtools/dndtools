...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Feat.short_description'
        db.delete_column('dnd_feat', 'short_description')


    def backwards(self, orm):
        
        # Adding field 'Feat.short_description'
        db.add_column('dnd_feat', 'short_description', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)
