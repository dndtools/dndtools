...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RaceSpeed.race'
        db.add_column('dnd_racespeed', 'race', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['dnd.Race']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RaceSpeed.race'
        db.delete_column('dnd_racespeed', 'race_id')
