...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rulebook.img_url'
        db.alter_column('dnd_rulebook', 'img_url', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Rulebook.img_url'
        db.alter_column('dnd_rulebook', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=255))
